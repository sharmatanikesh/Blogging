...
// .wrangler/tmp/bundle-w9ombS/checked-fetch.js
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/Users/shobhittomer/Documents/medium/backend/node_modules/@prisma/client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
...
// .wrangler/tmp/bundle-w9ombS/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-w9ombS/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
userRoute.post("/signup", async (c) => {
  ...
  try {
    ...
    const jwt = await sign2({ id: user.id }, c.env.JWT_SECRET);
    return c.json({ jwt });
  } catch (e) {
    c.status(403);
    console.log(e);
